...
#------------------------------------------------------------------
# Make sure to update streamlit using:
# pip install --upgrade streamlit
#------------------------------------------------------------------

# Command sets page to full width:
st.set_page_config(layout='wide')

#------------------------------------------------------------------

#Title:
image = Image.open('crypto_image.jpg')

st.image(image, width = 600)

st.title("Crypto Price App")
st.markdown("""
This is app retrives cryptocurrency prices for the top 100 cryptocurency from the **CoinMarketCap**! """)
...
col1.subheader('Currency is in USD')
